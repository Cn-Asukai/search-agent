...
| Publish Docker images | `.github/workflows/publish-ghcr.yml` | 仅 tag push；推送 GHCR 与 CNB 镜像。**PR 不会触发，不要空等** |
| Sync to CNB | `.github/workflows/sync-cnb.yml` | 任意 `push`（含 tag）；同步到 CNB 个人仓 |
